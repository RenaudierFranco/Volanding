    ...
    return(
        <>
            ...
            <Container className=" d-flex flex-column text-center align-items-center" w="100" mt="5">
                <Jumbotron text="left" h="100" shadow p="3" mb="5" bg="light" rounded>
                    <Form className="">
                    <Form.Group>
                    ...
                    <Button className="m-3" primary type="submit" onClick={handleRegister}>Registrarse</Button>
            ...
            >
                <Jumbotron text="center" w="100" h="100" shadow p="3" mb="5" bg="light" rounded>
                    <Alert primary className="w-100 mb-5 text-center">Registrarse como operador</Alert>
                    <Form>
                        <Row>
                            <Col>
                        ...
                        <Button w="30" mt="3" mr="2" primary type="submit" onClick={handleRegister}>Volver</Button>
                        <Button w="30" mt="3" ml="2" primary type="submit" onClick={createOperatorUser}>Registrarse</Button>
                    </Form>
                </Jumbotron>
            </Container>
            }
